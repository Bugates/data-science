...
- Once I started paying more attention to how the points are grouped by
  date the real data looked less random to me. There are several days
  where a bunch of measurements are high together and other days where a
  bunch are lower together.
...
- inititally I thought the difference between the real and simulated
  ...
  more interesting difference is actually the day to day structure. This
  makes me wonder if some part of the experimental conditions was
  changing between days instead of every measurement just being a random
  variation around one fixed value.
